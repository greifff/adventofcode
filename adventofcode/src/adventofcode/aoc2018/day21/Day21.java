...
import adventofcode.aoc2018.day19.Dataset;
import adventofcode.aoc2018.day19.Operation;
import adventofcode.aoc2018.day19.Registers;
import adventofcode.util.IOUtil;

public class Day21 {

	public static void main(String[] args) {
		List<String> data = IOUtil.readFile("2018/day21.data");

		int ipRegister = Integer.parseInt(data.get(0).substring(4));
		data.remove(0);

		// part 2: modify register 0 to value 1
		Registers.INSTANCE.registers[0] = 6190977;
